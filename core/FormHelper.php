...
class FormHelper {
    ...
    public static function inputBlock($type, $label, $name, $value = '', $placeholder = '', $inputAttrs = [], $divAttrs = []) {
        $divString = self::stringifyAttrs($divAttrs);
        $inputString = self::stringifyAttrs($inputAttrs);
        $html = '<div' . $divString . '>';
        $html .= '<label for = "' . $name . '">' . $label . '</label>';
        $html .= '<input type="' . $type . '" id="' . $name . '" name="' . $name . '" placeholder="' . $placeholder . '" value="' . $value . '"' . $inputString . ' />';
        $html .= '</div>';
        return $html;
    }
    ...
    public static function chechboxBlock($label, $name, $checked = false, $inputAttrs = [], $divAttrs = []) {
        $divString = self::stringifyAttrs($divAttrs);
        $inputString = self::stringifyAttrs($inputAttrs);
    ...
    public static function displayErrors($errors) {
        ...
        $html = '<div class="form-errors"><ul class="alert-err ' . $hasErrors . '">';
