...
class Model {
    ...
    public function find($params = []) {
        $param = $this->_softDeleteParams($params);
        $resultsQuery = $this->_db->find($this->_table, $param, get_class($this));
        if (!$resultsQuery)
            return [];
        return $resultsQuery;
    }
    ...
    public function findFirst($params = []) {
        $param = $this->_softDeleteParams($params);
        $resultQuery = $this->_db->findFirst($this->_table, $param, get_class($this));
        return $resultQuery;
    }
